...
public class DmiComparatorTest {
    ...
    private List<DmiDiff.DiffEntry> getExpectedEntries() {
        return Arrays.asList(
                new DmiDiff.DiffEntry("up", new DmiSprite(imgPH(), SpriteDir.SOUTH, 1), null),
                new DmiDiff.DiffEntry("up", new DmiSprite(imgPH(), SpriteDir.NORTH, 1), null),
                new DmiDiff.DiffEntry("up", new DmiSprite(imgPH(), SpriteDir.EAST, 1), null),
                new DmiDiff.DiffEntry("up", new DmiSprite(imgPH(), SpriteDir.WEST, 1), null),

                new DmiDiff.DiffEntry("down", new DmiSprite(imgPH(), SpriteDir.SOUTH, 1), new DmiSprite(imgPH(), SpriteDir.SOUTH, 1)),

                new DmiDiff.DiffEntry("folded", new DmiSprite(imgPH(), SpriteDir.SOUTH, 3), null),
                new DmiDiff.DiffEntry("folded", new DmiSprite(imgPH(), SpriteDir.NORTH, 3), null),
                new DmiDiff.DiffEntry("folded", new DmiSprite(imgPH(), SpriteDir.EAST, 3), null),
                new DmiDiff.DiffEntry("folded", new DmiSprite(imgPH(), SpriteDir.WEST, 3), null),

                new DmiDiff.DiffEntry("folded_new_state", null, new DmiSprite(imgPH(), SpriteDir.SOUTH, 1)),
                new DmiDiff.DiffEntry("folded_new_state", null, new DmiSprite(imgPH(), SpriteDir.SOUTH, 2)),
                new DmiDiff.DiffEntry("folded_new_state", null, new DmiSprite(imgPH(), SpriteDir.SOUTH, 3)),
                new DmiDiff.DiffEntry("folded_new_state", null, new DmiSprite(imgPH(), SpriteDir.NORTH, 1)),
                new DmiDiff.DiffEntry("folded_new_state", null, new DmiSprite(imgPH(), SpriteDir.NORTH, 2)),
                new DmiDiff.DiffEntry("folded_new_state", null, new DmiSprite(imgPH(), SpriteDir.NORTH, 3)),
                new DmiDiff.DiffEntry("folded_new_state", null, new DmiSprite(imgPH(), SpriteDir.EAST, 1)),
                new DmiDiff.DiffEntry("folded_new_state", null, new DmiSprite(imgPH(), SpriteDir.EAST, 2)),
                new DmiDiff.DiffEntry("folded_new_state", null, new DmiSprite(imgPH(), SpriteDir.EAST, 3)),
                new DmiDiff.DiffEntry("folded_new_state", null, new DmiSprite(imgPH(), SpriteDir.WEST, 1)),
                new DmiDiff.DiffEntry("folded_new_state", null, new DmiSprite(imgPH(), SpriteDir.WEST, 2)),
                new DmiDiff.DiffEntry("folded_new_state", null, new DmiSprite(imgPH(), SpriteDir.WEST, 3))
        );
    }
